...
5. The current version *does not implement convenience functions* like `predict`, `resid`, `summary` etc that users rely on for quick post-processing (model diagnostics, evaluation, etc) -- these should be added.
