...
A natural follow-up to this topic is the regression topic [Density-on-scalar regression with inference for density data](#density-on-scalar-regression-with-inference-for-density-data-ma) below.
